<?php
function form_input_f125_step1()
{
    ...
    <div id="custom-form" class="col-md-6 col-xs-12 col-sm-12">
		<div id="custom-form-header" class="col-md-12 col-xs-12 col-sm-12">
			<h4>Form input F-1.25 / Permohonan Pindah WNI - Step 1</h4>
		</div>
		<div id="custom-form-content" class="col-md-12 col-xs-12 col-sm-12">
			<h5><strong>Data Daerah Asal</strong></h5>
            <form method="post" action="?page1=f125-input&step=2">  
...
function form_input_f125_step2()
{
	...
	<div id="custom-form" class="col-md-6 col-xs-12 col-sm-12">
		<div id="custom-form-header" class="col-md-12 col-xs-12 col-sm-12">
			<h4>Form input F-1.25 / Permohonan Pindah WNI - Step 2</h4>
		</div>
		<div id="custom-form-content" class="col-md-12 col-xs-12 col-sm-12">
			<h5><strong>Data Kepindahan</strong></h5>
            <form method="post" action="?page1=f125-input&step=3">  
				...
				<div class="clear"></div>
                <a href="?page1=f125-input&step=1" class="btn btn-danger">Sebelumnya</a>
                <input type="submit" class="btn btn-primary" value="Selanjutnya">
            </form>
		</div>
	</div>
...
function form_input_f125_step3($jumlah_anggota_keluarga_yang_pindah)
{
	?>
	<div id="custom-form" class="col-md-6 col-xs-12 col-sm-12">
		<div id="custom-form-header" class="col-md-12 col-xs-12 col-sm-12">
			<h4>Form input F-1.25 / Permohonan Pindah WNI - Step 3</h4>
		</div>
		<div id="custom-form-content" class="col-md-12 col-xs-12 col-sm-12">
			<h5><strong>Anggota Keluarga yang Pindah</strong></h5>
            <form method="post" action="?page1=f125-input&step=4">
				...
				<div class="clear"></div>
                <a href="?page1=f125-input&step=2" class="btn btn-danger">Sebelumnya</a>
                <input type="submit" class="btn btn-primary" value="Selanjutnya">
            </form>
		</div>
	</div>
